...
module.exports = haruka = async (haruka, m, chatUpdate) => {
try {
...
var isCreator = [haruka.user.id, ...global.owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
var itsMe = m.sender == haruka.user.id ? true : false
...
var groupMetadata = m.isGroup ? await haruka.groupMetadata(m.chat).catch(e => {}) : ''
...
haruka.sendMessage(m.chat, {text: `*Antilink Group Terdeteksi*\n\nKamu akan dikeluarkan dari group ${groupMetadata.subject}`}, {quoted:m})
...
this.suit = this.suit ? this.suit : {}
	    ...
	    haruka.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
	    ...
	    haruka.sendText(m.chat, `Suit telah dikirimkan ke chat
...
klik https://wa.me/${nomorbot.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) haruka.sendText(roof.p, `Silahkan pilih \n\nBatu\nKertas\nGunting`, m)
	    if (!roof.pilih2) haruka.sendText(roof.p2, `Silahkan pilih \n\nBatu\nKertas\nGunting`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) haruka.sendText(m.chat, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    haruka.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    if (!roof.pilih2) haruka.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    m.reply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
	    if (!roof.pilih) haruka.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
	    }
	    ...
	    haruka.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
if (m.message) {
console.log(chalk.black(chalk.bgWhite('[ haruka YT ]')), chalk.black(chalk.bgGreen(new Date)), chalk.black(chalk.bgBlue(budy || m.mtype)) + '\n' + chalk.magenta('=> Dari'), chalk.green(pushname), chalk.yellow(m.sender) + '\n' + chalk.blueBright('=> Di'), chalk.green(m.isGroup ? pushname : 'Private Chat', m.chat))
}

//━━━━━━━━━━━━━━━[ SEND MESSAGE ]━━━━━━━━━━━━━━━━━//

var sendMess = (from, teks) => {
return haruka.sendMessage(from, { text: teks })
}
...
if (mime.split("/")[1] === "gif") {
return haruka.sendMessage(m.chat, { video: await convertGif(url), caption: caption, gifPlayback: true, mentions: men ? men : []}, {quoted: m})
}
let type = mime.split("/")[0]+"Message"
if(mime.split("/")[0] === "image"){
return haruka.sendMessage(m.chat, { image: await getBuffer(url), caption: caption, mentions: men ? men : []}, {quoted: m})
} else if(mime.split("/")[0] === "video"){
return haruka.sendMessage(m.chat, { video: await getBuffer(url), caption: caption, mentions: men ? men : []}, {quoted: m})
...
return haruka.sendMessage(m.chat, { document: await getBuffer(url), mimetype: mime, caption: caption, mentions: men ? men : []}, {quoted: m })
}
}

haruka.sendReadReceipt(m.chat, sender, [m.key.id])        

//━━━━━━━━━━━━━━━[ FAKE ]━━━━━━━━━━━━━━━━━//

const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync('./image/haruka2.jpg'), surface: 200, message: `DzOfc`, orderTitle: 'Please Subscribe Youtube haruka YT', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
│
└───────⭓`
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./image/haruka2.jpg') }, { upload: haruka.waUploadToServer })
...
haruka.relayMessage(m.chat, template.message, { messageId: template.key.id })
}
break
case 'revoke':
...
let link = await haruka.groupRevokeInvite(m.chat)
...
await haruka.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
case 'add': {
if (!m.isGroup) throw mess.group
...
let buttonsVote = [
  ...
  {buttonId: `${prefix}devote`, buttonText: {displayText: 'DEVOTE'}, type: 1}
            ...
            let buttonMessageVote = {
                text: teks_vote,
                footer: haruka.user.name,
                buttons: buttonsVote,
                headerType: 1
            }
            haruka.sendMessage(m.chat, buttonMessageVote)
	    }
            break
               case 'upvote': {
            if (!m.isGroup) throw mess.group
...
*${prefix}hapusvote* - untuk menghapus vote`
            ...
            haruka.sendMessage(m.chat, buttonMessageUpvote)
	    }
             break
                case 'devote': {
            if (!m.isGroup) throw mess.group
...
*${prefix}hapusvote* - untuk menghapus vote`
            ...
            haruka.sendMessage(m.chat, buttonMessageDevote)
	}
            break
...
©${haruka.user.id}
`
haruka.sendTextWithMentions(m.chat, teks_vote, m)
break
...
if (!isGroupAdmins && !m.key.fromMe) throw mess.admin
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await haruka.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
case 'demote': {
if (!m.isGroup) throw mess.group
...
if (!isGroupAdmins && !m.key.fromMe) throw mess.admin
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await haruka.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
...
if (!isGroupAdmins && !m.key.fromMe) throw mess.admin
if (!text) throw 'Text ?'
await haruka.groupUpdateSubject(m.chat, text).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
...
await haruka.updateProfilePicture(haruka.user.id, { url: media }).catch((err) => fs.unlinkSync(media))
await fs.unlinkSync(media)
}
}
break
...
await haruka.groupSettingUpdate(m.chat, 'announcement').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
} else if (args[0].toLowerCase() === 'open') {
await haruka.groupSettingUpdate(m.chat, 'not_announcement').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
}
break
...
if (!m.isGroup) throw mess.group
if (!isGroupAdmins && !m.key.fromMe) throw mess.admin
var group = await haruka.groupMetadata(m.chat)
...
haruka.sendMessage(m.chat, optionshidetag, text)
break
case 'hidetag2':
if (!m.isGroup) throw mess.group
if (!isCreator && !m.key.fromMe) throw mess.owner
...
teks += `\n⋙ haruka YT ⋘`
haruka.sendMessage(m.chat, { text: teks, mentions: groupMembers.map(a => a.id) }, { quoted: m })
break
case 'tag': case 'totag': case 'hidetag': {
			if (!isGroupAdmins && !isCreator && !m.key.fromMe) return m.reply('Eitssss Ngga Bisa')
			let cc = smsg(haruka, q ? m : m.quoted ? await quoted.fakeObj : false || m)
		        let cck = q ? q : cc.text
			await haruka.copyNForward(m.chat, haruka.cMod(m.chat, cc, /hidetag|tag|totag/i.test(cck) ? cck : `${cck}`, { contextInfo: { mentionedJid: participants.map(v => v.jid) }}), true, { contextInfo: { mentionedJid: participants.map(v => v.jid) }}).catch(_ => _)
		}
		break
...
case 'iqra': {
		...
		haruka.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
case 'juzamma': {
		if (args[0] === 'pdf') {
		m.reply(mess.wait)
		haruka.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:m})
		} else if (args[0] === 'docx') {
		m.reply(mess.wait)
		haruka.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:m})
		} else if (args[0] === 'pptx') {
		m.reply(mess.wait)
		haruka.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:m})
		} else if (args[0] === 'xlsx') {
		m.reply(mess.wait)
		haruka.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:m})
		} else {
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		m.reply(txt)
		haruka.sendMessage(m.chat, {audio: { url: res.result.data.audio.primary }, mimetype: 'audio/mpeg'}, { quoted : m })
		}
		break
case 'tafsirsurah': {
...
let encmedia = await haruka.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await haruka.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
m.reply(mess.wait)
idoganz = args.join(' ')
let smeme = await haruka.downloadAndSaveMediaMessage(quoted)
...
let smemenya = await haruka.sendImageAsSticker(m.chat, gaskeun, m, { packname: global.packname, author: global.author })
...
case 'emojimix': {
		...
		for (let res of anu.results) {
		    let encmedia = await haruka.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
		    await fs.unlinkSync(encmedia)
		}
	    }
	    break
...
await haruka.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: m })
await fs.unlinkSync(media)
}
break
case 'tomp3':
	    ...
	    haruka.sendMessage(m.chat, {audio: hua, mimetype: 'audio/mp4'}, {quoted:m})
...
let media = await haruka.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await haruka.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted: m })
await fs.unlinkSync(media)
}
break
case 'tovn': case 'toptt': {
            ...
            haruka.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
            }
            break
...
+ `END:VCARD`
let msg = await haruka.sendMessage(m.chat, { contacts: { displayName: `${ownername}`, contacts: [{ vcard }] } }, { quoted: m })
let buttons3 = [
...
haruka.sendMessage(m.chat, buttonMessage3, { quoted: m })                        
}
break
case 'eval': {
...
if (!isCreator && !m.key.fromMe) throw mess.owner
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await haruka.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
case 'unblock': {
if (!isCreator && !m.key.fromMe) throw mess.owner
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await haruka.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
case 'sc': {
m.reply('Cari Sc Ya kak?Nih\nhttps://github.com/harukakawaiiii/harukaMDV2')
}
break

case 'doaharian': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/doaharian', {}, 'apikey'))
...
haruka.sendMessage(m.chat, buttonMessage, { quoted: ftroli })
}
break
case 'tahlil': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/tahlil', {}, 'apikey'))
resultnya = webapi.result
txt =`Id : ${resultnya.id}
...
case 'wirid': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/wirid', {}, 'apikey'))
resultnya = webapi.result
txt =`Id : ${resultnya.id}
...
case 'ayatkursi': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/ayatkursi', {}, 'apikey'))
resultnya = webapi.result
...
case 'bacaansholat': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/bacaansholat', {}, 'apikey'))
resultnya = webapi.result
txt =`Id : ${resultnya.id}
Name : ${resultnya.name}
Arabic : ${resultnya.arabic}
...
case 'niatsholat': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/niatsholat', {}, 'apikey'))
resultnya = webapi.result
txt =`Id : ${resultnya.id}
Name : ${resultnya.name}
Arabic : ${resultnya.arabic}
...
case 'asmaulhusna': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/asmaulhusna', {}, 'apikey'))
resultnya = webapi.result
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/ytMp4', { url: text }, 'apikey'))
...
if (!text) throw `Example : ${prefix + command} https://youtube.com/watch?v=PtFMh6Tccag%27`
                ...
                haruka.sendMessage(m.chat, { video: { url: dl_link }, caption: `⭔ Title : ${title}\n⭔ File Size : ${filesizeF}\n⭔ Url : ${text}\n⭔ Ext : MP4` }, { quoted: m })
            }
            break
case 'ytmp33': {
if (!text) throw 'Masukkan Link Youtube Nya'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/ytMp3', { url: text }, 'apikey'))
imagenya = await getBuffer(webapi.result.thumb)
var template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
...
if (!text) throw `Example : ${prefix + command} https://youtube.com/watch?v=PtFMh6Tccag%27`
                ...
                let { dl_link, thumb, title, filesizeF, filesize } = result
                if (Number(filesize) >= 40000) return m.reply('File Melebihi Batas'+util.format(result))
                haruka.sendImage(m.chat, thumb, `⭔ Title : ${title}\n⭔ File Size : ${filesizeF}\n⭔ Url : ${text}\n⭔ Ext : MP3`, m)
                haruka.sendMessage(m.chat, { document: { url: dl_link }, fileName: `${title}.mp3`, mimetype: 'audio/mp3' }, { quoted: m })
            }
            break
case 'play': {
if (!text) throw 'Masukkan Link Youtube Nya'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/ytPlay', { query: text }, 'apikey'))
imagenya = await getBuffer(webapi.result.thumb)
var template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/tiktokvideo', { url: text }, 'apikey'))
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/tiktokvideo', { url: text }, 'apikey'))
haruka.sendMessage(m.chat, { video: { url: webapi.result.result.nowm }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/tiktokvideo', { url: text }, 'apikey'))
haruka.sendMessage(m.chat, { video: { url: webapi.result.result.wm }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
case 'mediafiredl': case 'mediafire': {
if (!text) throw 'Masukkan Link Mediafire Nya'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/mediafireD', { url: text }, 'apikey'))
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/igfoto', { link: text }, 'apikey'))
haruka.sendMessage(m.chat, { image: { url: webapi.result.link }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
case 'igvideo': {
if (!text) throw 'Masukkan Link Video Instragram'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/igtv', { link: text }, 'apikey'))
haruka.sendMessage(m.chat, { video: { url: webapi.result.link }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
case 'git': case 'gitclone':
  ...
  haruka.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m })
			 break
case 'katabijak': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/bijak', {},'apikey'))
...
case 'fakta': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/fakta', {},'apikey'))
...
case 'motivasi': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/motivasi', {},'apikey'))
...
case 'quotes': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/quotes', {},'apikey'))
...
case 'bucin': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/bucin', {},'apikey'))
...
case 'pantun': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/Pantun', {},'apikey'))
...
case 'cerpen': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/cerpen', {},'apikey'))
...
case 'quotesanime': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/quotesAnime', {},'apikey'))
resultnya = webapi.result
...
m.reply(mess.wait)
webapi = await getBuffer(api('haruka', '/ttp', { text: text }, 'apikey'))
haruka.sendMessage(m.chat, {image: webapi, caption: `stikerin banh`}, {quoted:ftroli})
}
break
case 'blackpink':
case 'neon':
...
if (!text) throw 'Teks Nya Mana ?'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', `/${command}`, { text: text }, 'apikey'))
haruka.sendMessage(m.chat, { image: { url: webapi.data }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
case '3dchristmas': case '3ddeepsea': case 'americanflag': case '3dscifi': case '3drainbow': case '3dwaterpipe': case 'halloweenskeleton': case 'sketch': case 'bluecircuit': case 'space': case 'metallic': case 'fiction': case 'greenhorror': case 'transformer': case 'berry': case 'thunder': case 'magma': case '3dcrackedstone': case '3dneonlight': case 'impressiveglitch': case 'naturalleaves': case 'fireworksparkle': case 'matrix': case 'dropwater':  case 'harrypotter': case 'foggywindow': case 'neondevils': case 'christmasholiday': case '3dgradient': case 'blackpink': case 'gluetext': {
                if (!text) throw `Example : ${prefix + command} haruka|Botz`
                m.reply(mess.wait)
                let anu = await getBuffer(api('zenz', '/textpro/'+command, { text: text }, 'apikey'))
                haruka.sendMessage(m.chat, { image: anu, caption: `Download From ${text}` }, { quoted: m})
	    }
            break
case 'ffcover': case 'crossfire': case 'galaxy': case 'glass': case 'neon': case 'beach': case 'blackpink': case 'igcertificate': case 'ytcertificate': {
                if (!text) throw 'No Query Text'
                m.reply(mess.wait)
                haruka.sendMessage(m.chat, { image: { url: api('zenz', '/ephoto/' + command, { text: text }, 'apikey') }, caption: `Ephoto ${command}` }, { quoted: m })
            }
            break
case 'shadow': case 'romantic': case 'smoke': case 'burnpapper': case 'naruto': case 'lovemsg': case 'grassmsg': case 'lovetext': case 'coffecup': case 'butterfly': case 'harrypotter': case 'retrolol': {
                if (!text) throw 'No Query Text'
                m.reply(mess.wait)
                haruka.sendMessage(m.chat, { image: { url: api('zenz', '/photooxy/' + command, { text: text }, 'apikey') }, caption: `Photo Oxy ${command}` }, { quoted: m })
            }
            break
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            this.suit[id] = {
            chat: await haruka.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) haruka.sendText(m.chat, `_Waktu suit habis_`, m)
            delete this.suit[id]
...
case 'tebak': {
                ...
                if (args[0] === "lagu") {
                    ...
                    let msg = await haruka.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
                    haruka.sendText(m.chat, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    haruka.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, haruka.user.name, m)
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    haruka.sendImage(m.chat, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    haruka.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, haruka.user.name, m)
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    haruka.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
                    tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    haruka.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, haruka.user.name, m)
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    haruka.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, haruka.user.name, m)
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    haruka.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    haruka.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, haruka.user.name, m)
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    haruka.sendText(m.chat, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    haruka.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, haruka.user.name, m)
...
case 'asupan': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', `/${command}`, {}, 'apikey'))
haruka.sendMessage(m.chat, { video: { url: webapi.result.url }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
case 'cewekchina':
case 'cewekindonesia':
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', `/${command}`, {}, 'apikey'))
haruka.sendMessage(m.chat, { image: { url: webapi.result.url }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', `/${command}`, {}, 'apikey'))
haruka.sendMessage(m.chat, { image: { url: webapi.result }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
case 'yuri':
case 'pussy': {
m.reply(mess.wait)
myapi = await fetchJson(api('harukayt', `/${command}`, {}, 'apikey'))
haruka.sendMessage(m.chat, { image: {url: myapi.result }, caption: `Done Nih....`}, { quoted: ftroli })
}
break
case 'xnxxsearch': {
if (m.isGroup) return m.reply('Fitur Tidak Dapat Digunakan Untuk Group!')
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/xnxxsearch', { query: text }, 'apikey'))
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/xnxxdl', { url: text }, 'apikey'))
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/xnxxdl', { url: text }, 'apikey'))
haruka.sendMessage(m.chat, { video: { url: webapi.result.result.files.low }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
case 'high': {
if (!text) throw 'Link Video Bokep Nya Mana ?'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/xnxxdl', { url: text }, 'apikey'))
haruka.sendMessage(m.chat, { video: { url: webapi.result.result.files.high }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
case 'hls': {
if (!text) throw 'Link Video Bokep Nya Mana ?'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/xnxxdl', { url: text }, 'apikey'))
haruka.sendMessage(m.chat, { video: { url: webapi.result.result.files.hls }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/artinama', { nama: text }, 'apikey'))
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/cariresep', { query: text }, 'apikey'))
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/liriklagu', { query: text }, 'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
txt =`Lirik : ${x.result}`
}
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/wikisearch', { query: text }, 'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
txt =`Wiki : ${x.wiki}
Judul : ${x.judul}`
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/pinterest', { query: text }, 'apikey'))
haruka.sendMessage(m.chat, { image: { url: webapi.result.url }, caption: `Nih Kak....`}, { quoted: ftroli })
}
break
case 'linkwa': {
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/linkwa', { nama: text }, 'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
txt =`Nama : ${x.nama}\nLink : ${x.link}`
}
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/playstore', { name: text }, 'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
...
case 'gempa': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/gempa', {}, 'apikey'))
...
case 'kompas': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/kompas', {}, 'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
txt =`Title : ${x.title}\nDesc : ${x.desc}\nDate : ${x.date}\nLink : ${x.link}`
}
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/film', { query: text }, 'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
txt =`Author : ${x.author}\nJudul : ${x.judul}\nQuality : ${x.quality}\nType : ${x.type}\nUpload : ${x.upload}\nLink : ${x.link}`
imagenya = await getBuffer(x.thumb)
...
case 'tribunnews': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/tribunnews', {},'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
txt =`Title : ${x.title}\nDesc : ${x.desc}\nDate : ${x.date}\nLink : ${x.link}`
}
...
case 'jadwalbola': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/jadwalbola', {},'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
txt =`Author : ${x.author}\nJadwal : ${x.jadwal}\nTanggal : ${x.tanggal}\nJam : ${x.jam}\nUrl : ${x.url}`
}
...
case 'jadwaltv': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/jadwaltv', {},'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
txt =`Author : ${x.author}\nAcara : ${x.acara}\nChannel : ${x.channel}\nJam : ${x.jam}\nSource : ${x.source}`
}
...
case 'jadwalsholat': {
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/jadwalsholat', {},'apikey'))
...
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/scrapKusonime', { query: text },'apikey'))
...
haruka.sendMessage(m.chat, { image: { url: webapi.result.thumb }, caption: txt}, { quoted: ftroli })
}
break
case 'manggatoon': {
if (!text) throw 'Judul Anime Nya Mana ?'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/manggaToon', { judul: text },'apikey'))
...
if (!text) throw 'Judul Anime Nya Mana ?'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/chara', { query: text },'apikey'))
...
if (!text) throw 'Judul Anime Nya Mana ?'
m.reply(mess.wait)
webapi = await fetchJson(api('haruka', '/anime', { query: text },'apikey'))
resultnya = webapi.result
for (var x of resultnya) {
txt =`Judul : ${x.judul}\nLink : ${x.link}`
}
...
if (budy.includes('6285335877178')) {  
haruka.sendMessage(m.chat, {text: 'Ada Apa Ya Tags Owner Saya'}, {quoted: ftroli})
	  }	  
